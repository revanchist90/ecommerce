...
public class OrderService {
    ...
    public OrderResponse createOrder(CreateOrderRequest request) {
        ...
        Order order = Order.builder()
                ...
                .totalAmount(computeTotal(request))
                .build();
    ...
    private void validateInventory(List<CreateOrderRequest.LineRequest> lines) {
        Map<UUID, Integer> requestedByProduct = lines.stream()
                .collect(Collectors.groupingBy(
                        CreateOrderRequest.LineRequest::productId,
                        Collectors.summingInt(CreateOrderRequest.LineRequest::quantity)
                ));
    ...
    private OrderLine toOrderLine(CreateOrderRequest.LineRequest line) {
    ...
    private BigDecimal computeTotal(CreateOrderRequest request) {
